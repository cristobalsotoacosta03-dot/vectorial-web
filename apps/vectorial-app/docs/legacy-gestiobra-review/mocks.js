// ─── Datos mock — fallback cuando Supabase no está disponible ─────────────────
...
export const OPERARIOS_MOCK = [
  { id: '1', nombre: 'Juan García López',    especialidad: 'Instalaciones de gas',  categoria: 'oficial',      telefono: '612 345 678', tarifa_hora: 28.00, activo: true },
  { id: '2', nombre: 'María Torres Ruiz',    especialidad: 'Climatización HVAC',    categoria: 'oficial',      telefono: '623 456 789', tarifa_hora: 30.00, activo: true },
  { id: '3', nombre: 'Carlos Martín Soto',   especialidad: 'Fontanería ACS',        categoria: 'encargado',    telefono: '634 567 890', tarifa_hora: 32.00, activo: true },
  { id: '4', nombre: 'Ana Fernández Gil',    especialidad: 'Electricidad REBT',     categoria: 'peon',         telefono: '645 678 901', tarifa_hora: 18.50, activo: true },
  { id: '5', nombre: 'Pedro Romero Vega',   especialidad: 'Obra civil y soldadura', categoria: 'oficial',      telefono: '656 789 012', tarifa_hora: 26.00, activo: true },
]
